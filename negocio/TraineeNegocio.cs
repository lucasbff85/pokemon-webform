    ...
    public class TraineeNegocio
    {
        public void actualizar(Trainee user)
        {
            ...
            try
            {
                ...
                //datos.setearParametro("@imagen", user.ImagenPerfil != null ? user.ImagenPerfil : DBNull.Value);  CASTEO IMPLICITO  esto funciona en versiones mas avanzadas de c#
                //datos.setearParametro("@imagen", user.ImagenPerfil != null ? user.ImagenPerfil : "");  no quiere DBNull y tampoco null, por eso va string vacia
        ...
        public bool Login(Trainee trainee)
        {
            ...
            try
            {
                ...
                if (datos.Lector.Read())
                {
                    ...
                    if(!(datos.Lector["imagenPerfil"] is DBNull))   //validamos porque sino da error al cargar dato nulo
